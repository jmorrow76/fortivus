    ...
    return (
      <Card className="mt-6 border-accent/20">
        ...
        <CardContent className="space-y-4">
          ...
          {/* Daily Devotional */}
          {recommendation.devotional && (
            <div className="p-4 bg-primary/5 rounded-lg border border-primary/20">
              <div className="flex items-center gap-2 mb-3">
                <BookOpen className="h-4 w-4 text-primary" />
                <h4 className="font-medium text-sm">Today's Devotional</h4>
              </div>
              <div className="space-y-3">
                <div className="text-center">
                  <p className="font-heading text-lg font-semibold text-primary">
                    {recommendation.devotional.verse}
                  </p>
                  <p className="text-sm italic text-foreground mt-2">
                    "{recommendation.devotional.text}"
                  </p>
                </div>
                <p className="text-sm text-muted-foreground">
                  {recommendation.devotional.reflection}
                </p>
              </div>
            </div>
          )}
