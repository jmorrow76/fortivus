            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    {healthAuthorized ? 'Synced from your device' : 'Connect your wearable'}
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  {healthAuthorized ? (
                    ...
                    <div className="text-center py-6 text-muted-foreground">
                      ...
                      <p>Health data available on mobile app</p>
                      <p className="text-sm">Connect Apple Health or Google Fit</p>
                    </div>
                  )}
                </CardContent>
              </Card>
